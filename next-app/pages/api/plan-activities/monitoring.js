  ...
  const activities = await prisma.planActivity.findMany({
    ...
    include: {
      ...
      logs: {
        ...
        take: 1,
        select: { id: true, status: true, performedAt: true, quantityDone: true, setsDone: true, repsDone: true, timeSec: true, distanceDone: true, loadUsed: true, attempts: true, notes: true }
      }
    },
