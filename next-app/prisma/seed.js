...
async function seedTestData(ref) {
  ...
  const activitySeed = [
    ...
    ["test101", 37, "Freestyle drill set", "skill_technique", 20, "attempts", 5, null, null, null, 1, 1],
    ...
    ["test101", 37, "Freestyle drill set", "skill_technique", 25, "attempts", 5, null, null, null, 1, 2],
