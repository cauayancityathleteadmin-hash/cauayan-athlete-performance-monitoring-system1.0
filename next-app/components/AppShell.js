...
const NAV_GROUPS = [
  ...
  { key: "standing", label: "Standing", links: [{ href: "/standings", label: "Standing", icon: "trophy" }] },
  { key: "analytics", label: "Analytics", links: [{ href: "/analytics", label: "Analytics", icon: "barChart" }] },
